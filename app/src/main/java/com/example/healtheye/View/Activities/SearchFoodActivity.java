...
public class SearchFoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent fromClassiferIntent = getIntent();
        String classiferResult = fromClassiferIntent.getStringExtra("classifierResult");
        ...
        //If directed here by cameraActivity, display result without showing searchView
        //setup searchView
        ...
        if (classiferResult != null){
            searchView.setVisibility(View.INVISIBLE);
            fetchFood(usdaFoodSearchApi, classiferResult);
        }
    }

    public void fetchFood(USDAFoodAPI api, final String queryFoodName){
        String dataSource = "Standard Reference";
        Call<FoodSearch> searchFood = api.getFood(queryFoodName, my_api_key, dataSource);
